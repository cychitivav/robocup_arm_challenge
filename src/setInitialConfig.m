...
configReq.JointPositions = [-1.9494 -0.0346 -1.1962 -1.0550 0.0367 -2.0500 3*pi/4]; % DO NOT CHANGE INITIAL CONFIGURATION, it could affect behavior during final scoring
